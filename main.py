            ...
            if attempts % 5000000 == 0:
                if attempts > 999999999:
                    ...
                    if attempts >= 50000000:
                        ...
                        print()
                    print(colored("%s billion, %s million passwords guessed so far..." % (billions, millions), "cyan"))
                else:
                    replit.clear()
                    print(colored("Attempting to crack password via CyanCoding's BFPC...", "magenta"))
                    print()
...
if doneBefore == "no" or doneBefore == "nope" or doneBefore == "definitely not" or doneBefore == "is 9 + 10 = 21?" or doneBefore == "nuh uh":
    ...
    wait(6)
    print(colored("The program has priorities so lowercase letters are the highest priority with uppercase letters, then numbers, and lastly symbols.", "magenta"))
    wait(6)
    ...
    wait(8)
    learnMore = input(colored("Would you like to know what a BFPC is?", "yellow")).lower()
    time.sleep(2)
    if (learnMore in ["yes", "yea", "yeah", "ya", "yup", "yuppers", "okay", "ok", "sure", "yea bro why not", "might as well i've been waitin' for hours", "mhmm", "that'd be a yes thank you"]):
        replit.clear()
        ...
        wait(7)
        print(colored("And that is why there is a limit to how many times a password can be entered on most products these days.", "magenta"))
        wait(7)
...
wait(1)
if (customize in ["yes", "yea", "yeah", "ya", "yup", "yuppers", "okay", "ok", "sure", "yea bro why not", "might as well i've been waitin' for hours", "mhmm", "that'd be a yes thank you"]):
    replit.clear()
    ...
    if "?" in password:
        usingSyms = True
    wait(3)
    print(colored("Please type in the number of the characters you would like the program to test for", "magenta"))
    print()
    wait(2)
...
wait(2)
if password == "":
    print(colored("You didn't specify a password! The program didn't even need to look.", "cyan"))
else:
